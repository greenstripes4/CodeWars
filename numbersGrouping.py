"""
Task
You are given an array of integers that you want distribute between several groups. The first group should contain
numbers from 1 to 104, the second should contain those from 104 + 1 to 2 x 104, ..., the 100th one should contain
numbers from 99 x 104 + 1 to 106 and so on.
...
def numbers_grouping(a):
    return len(a) + len(set([math.ceil(i/10000) for i in a]))

print(numbers_grouping([10000,1]))